  ...
  return (
    <section className="bg-white py-10 border-b border-gray-100/50">
      <div className="mx-auto max-w-[1280px] px-4 md:px-6 lg:px-8">
        {/* Centered Heading (Bigger Titles & Subtitles) */}
        ...
        <div className="relative flex items-center">
          {/* Left Navigation Arrow (Bigger Arrow Button) */}
          <button
            type="button"
            onClick={() => scroll("left")}
          ...
          >
            ...
            {/* Logo 2: JAQUAR GROUP (Bigger Logo Card & Brand Font) */}
            <div className="flex h-24 min-w-[200px] flex-1 shrink-0 items-center justify-center rounded-2xl border border-gray-100/95 bg-white px-8 py-5 shadow-[0_10px_35px_rgba(0,0,0,0.015)] transition hover:border-gray-200 hover:shadow-[0_10px_35px_rgba(0,0,0,0.025)]">
            ...
            {/* Logo 3: ASTRAL PIPES (Bigger Logo Card & Brand Font) */}
            <div className="flex h-24 min-w-[200px] flex-1 shrink-0 items-center justify-center rounded-2xl border border-gray-100/95 bg-white px-8 py-5 shadow-[0_10px_35px_rgba(0,0,0,0.015)] transition hover:border-gray-200 hover:shadow-[0_10px_35px_rgba(0,0,0,0.025)]">
            ...
            {/* Logo 4: FINOLEX (Bigger Logo Card & Brand Font) */}
            <div className="flex h-24 min-w-[200px] flex-1 shrink-0 items-center justify-center rounded-2xl border border-gray-100/95 bg-white px-8 py-5 shadow-[0_10px_35px_rgba(0,0,0,0.015)] transition hover:border-gray-200 hover:shadow-[0_10px_35px_rgba(0,0,0,0.025)]">
              <div className="flex flex-col items-center select-none">
            ...
            {/* Logo 5: CERA (Bigger Logo Card & Brand Font) */}
            <div className="flex h-24 min-w-[200px] flex-1 shrink-0 items-center justify-center rounded-2xl border border-gray-100/95 bg-white px-8 py-5 shadow-[0_10px_35px_rgba(0,0,0,0.015)] transition hover:border-gray-200 hover:shadow-[0_10px_35px_rgba(0,0,0,0.025)]">
            ...
            {/* Logo 6: ASIAN PAINTS (Bigger Logo Card & Brand Font) */}
            <div className="flex h-24 min-w-[200px] flex-1 shrink-0 items-center justify-center rounded-2xl border border-gray-100/95 bg-white px-8 py-5 shadow-[0_10px_35px_rgba(0,0,0,0.015)] transition hover:border-gray-200 hover:shadow-[0_10px_35px_rgba(0,0,0,0.025)]">
          ...
          {/* Right Navigation Arrow (Bigger Arrow Button) */}
          <button
            type="button"
