...
const SERVICE_ICONS = [
  ...
  <svg key="leak" viewBox="0 0 24 24" className="h-8 w-8 text-[#9fd40b] fill-current" aria-hidden>
    <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0zM12 20a6 6 0 1 0-4.24-10.24L12 14l4.24-4.24A6 6 0 0 0 12 20z" />
  </svg>,
  // Drain Cleaning Services
  <svg key="drain" viewBox="0 0 24 24" className="h-8 w-8 text-[#9fd40b] fill-current" aria-hidden>
  ...
  <svg key="heater" viewBox="0 0 24 24" className="h-8 w-8 text-[#9fd40b] fill-current" aria-hidden>
  ...
  <svg key="toilet" viewBox="0 0 24 24" className="h-8 w-8 text-[#9fd40b] fill-current" aria-hidden>
  ...
  <svg key="pipe" viewBox="0 0 24 24" className="h-8 w-8 text-[#9fd40b] fill-current" aria-hidden>
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z" />
  </svg>,
  // General Plumbing Services
  <svg key="general" viewBox="0 0 24 24" className="h-8 w-8 text-[#9fd40b] fill-current" aria-hidden>
  ...
  return (
    <section className="bg-white py-10 overflow-hidden border-b border-gray-100/50">
      <div className="mx-auto max-w-[1280px] px-4 md:px-6 lg:px-8">
        ...
        {/* UPPER PART: Introduction Header + Image Card */}
        <div className="grid gap-12 lg:grid-cols-12 items-center mb-10">
          {/* Left Column: Text & CTA Row */}
          <div className="lg:col-span-7">
            {/* Tagline */}
            <div className="flex items-center gap-3">
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#0a1f44]/10 text-[#0a1f44]">
                <FaWrench className="text-[10px]" />
              </span>
              <span className="text-[13px] sm:text-[14px] font-extrabold text-[#0a1f44] tracking-wider uppercase">
                OUR SERVICES
              </span>
              <span className="w-16 h-[2.5px] bg-[#0a1f44] rounded-full" />
            </div>

            {/* Main Header */}
            <h2 className="mt-5 font-sans text-3xl md:text-[2.25rem] font-extrabold leading-tight text-[#001b3d] tracking-tight">
              Professional Plumbing{" "}
              <span className="block mt-1.5">Services You Can Trust</span>
            </h2>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {highlights.slice(0, 4).map((h: any, i: number) => (
                  <div key={h.label} className="flex items-center gap-2.5">
                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#0a1f44]/10 text-[#0a1f44]">
            ...
            <div className="flex flex-wrap items-center gap-5 mt-10">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#9fd40b] px-7 py-4 text-[13.5px] font-extrabold text-[#0a1f44] shadow-[0_10px_24px_rgba(159,212,11,0.3)] transition hover:bg-[#8fc00a] hover:scale-[1.02]"
              >
              ...
              <div className="inline-flex items-center gap-3.5 rounded-full border-2 border-gray-200/60 bg-white px-5.5 py-2.5">
                <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#0a1f44]/10 text-[#0a1f44]">
          ...
          <div className="lg:col-span-5 relative w-full h-[300px] md:h-[380px]">
            <div className="absolute inset-0 overflow-hidden bg-slate-50 rounded-3xl border border-slate-200 shadow-md">
              <MediaImage
            ...
            <div className="absolute bottom-6 left-6 right-6 sm:-left-4 sm:right-6 z-20 bg-[#001b3d] text-white p-4 rounded-2xl shadow-xl flex items-center gap-3.5 border border-white/10">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/10 text-white border border-white/15">
        ...
        <div className="border-t border-gray-100/80 pt-10">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3">
              <span className="w-8 h-[1.5px] bg-[#0a1f44] rounded-full" />
              <span className="text-[13px] sm:text-[14px] font-extrabold text-[#0a1f44] tracking-wider uppercase flex items-center gap-1.5">
            ...
            <h3 className="mt-3 font-sans text-3xl md:text-[2.25rem] font-extrabold text-[#001b3d] tracking-tight">
              Reliable <span className="text-[#0a1f44]">Plumbing</span> Solutions
            </h3>
          </div>
          ...
          <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 mb-8">
            {listings.slice(0, 6).map((item: any, i: number) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group bg-white border border-gray-100/90 rounded-2xl p-5 shadow-[0_8px_30px_rgba(0,0,0,0.015)] transition-all duration-300 hover:border-[#0a1f44]/20 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(10,31,68,0.06)] text-center flex flex-col items-center justify-between min-h-[290px]"
                >
                  <div className="flex flex-col items-center w-full">
                    {/* Soft Blue Circle Icon Wrapper */}
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#0a1f44] border border-[#0a1f44] transition-all duration-300 mb-5 text-[#9fd40b] group-hover:scale-105">
                      {icon}
                    </div>

                    {/* Card Title */}
                    <h4 className="font-sans text-[14px] font-extrabold text-[#001b3d] tracking-tight group-hover:text-[#0a1f44] transition duration-300 leading-snug">
                      {item.title}
                    </h4>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 text-[11px] font-extrabold text-[#0a1f44]/90 tracking-wider uppercase mt-5 group-hover:text-[#0a1f44]"
                  >
                    LEARN MORE
                ...
                {trustHighlights.slice(0, 4).map((item: any, i: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-[#0a1f44] border border-gray-200/55 shadow-sm">
                        {icon}
                      </span>
                      <div>
