...
export type WhyChooseUsPageData = {
  pretitle: string;
  title: string;
  desc: string;
  desc2?: string;
...
export type EmiCalculatorPageData = {
  pretitle: string;
  title: string;
  desc: string;
...
export type AreaConverterPageData = {
  pretitle: string;
  title: string;
  desc: string;
  defaultValue: number;
  fromUnit: string;
  toUnit: string;
  units: { label: string; value: string; toSqFt: number }[];
  valueLabel?: string;
  fromLabel?: string;
  toLabel?: string;
  resultLabel?: string;
...
export type InvestmentTipsPageData = {
  pretitle: string;
  title: string;
  desc: string;
  tips: InvestmentTipItem[];
  ctaButton?: ButtonItem;
  breadcrumb?: LinkItem[];
};
...
/** Category-specific page content (not shared chrome) */
export type CategoryPages = {
  InvestmentTipsPage: InvestmentTipsPageData;
  EmiCalculatorPage: EmiCalculatorPageData;
  AreaConverterPage: AreaConverterPageData;
  SellPage: SellPageData;
...
export const CATEGORIES: CategoryId[] = ["Service"];
...
export const ACTIVE_CATEGORY: CategoryId = "Service";
